        ...
        for param in self.param_list:
            if uri_param_values.get(param["parameter"]) == None:
                ...
                for parameter in parent_param_list:
                    if parameter.loc["parameter"] == param["parameter"]:
                        value = {param["parameter"]: param["value"]}
                    elif "Array" in parameter.loc["type"]:
                        value = {parameter.loc["parameter"]: [value]}
